...
create table questions (ques_id bigint(20) auto_increment primary key, question varchar(255) not null,
...
create table que_choices (choice_id bigint(20) auto_increment primary key, choice varchar(255) not null,
is_image bit(1) default 0, question_id bigint(20) references questions(que_id));